...
export const siteConfig: SiteConfig = {
	title: "橘贝Blog",
	//subtitle: "一个个人博客主页",
	siteURL: "https://blog.gbjimmy.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	pageScaling: {
		...
		targetWidth: 1500, // 目标宽度，低于此宽度时开始缩放
	},

	bangumi: {
		userId: "1192511", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
...
export const profileConfig: ProfileConfig = {
	avatar: "/assets/avatar/avatar.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "橘贝Jimmy",
	bio: "一个东方、型月爱好者",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客，不妨随便看看吧，右下角可以放音乐哦", // 公告内容
		...
		songs: [
			{
				title: "诀别",
				artist: "芳贺敬太(KATE)",
				url: "/assets/music/url/parting.webm", // 相对于 public 文件夹的路径
				cover: "/assets/music/cover/parting.jpg" // (可选) 歌曲封面
			},
		]
	}
};
